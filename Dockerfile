...
RUN apt-get update && add-apt-repository ppa:deadsnakes/ppa && apt-get install -y git curl maven python3-setuptools python3-pip python3.5-dev python3-boto3 && rm -rf /var/lib/apt/lists/*
