...
RUN apt-get install -y git curl maven python3-setuptools python3-pip python3.7 python3-boto3 && rm -rf /var/lib/apt/lists/*
...
ARG JENKINS_SHA=9caca69338547ffd469e822e33ae02a96358c0fe44b9a813d7c822f5fb84e1f9
